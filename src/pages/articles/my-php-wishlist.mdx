...
<div class="text-center rounded">
    <a href="https://fromphptopython.com">
        <img class="mx-auto rounded-lg max-w-full md:max-w-lg" src="https://fromphptopython-images.fra1.cdn.digitaloceanspaces.com/meta/og_image.png" alt="From PHP to Python course" />
    </a>
</div>
